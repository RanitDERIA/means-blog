    ...
    <div className="min-h-screen relative bg-white dark:bg-gray-900">
      ...
      <div className="max-w-2xl pt-20 pb-32 px-6 text-center mx-auto">
        ...
        <p className="text-gray-600 mt-4 dark:text-indigo-200">
          I am a self-taught developer currently pursuing B.Tech in Computer Science. My interests lie in building modern Web Applications and Products, along with exploring areas related to Machine Learning and Distributed Systems.
        </p>
