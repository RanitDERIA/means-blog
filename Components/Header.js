...
function Header({ topic, topicName, topicCount }) {
  return (
    <>
      {/* Add Adobe Fonts only for this component */}
      <Head>
        <link rel="stylesheet" href="https://use.typekit.net/vyu2vkx.css" />
      </Head>
      ...
      {!topic && (
        <div className="pt-24 px-12 mx-auto max-w-7xl">
          <div className="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
            {/* Apply custom Adobe font only here */}
            <p className="px-0 mb-2 text-lg font-bold custom-font text-gray-800 md:text-xl lg:px-24 dark:text-gray-300">
              Means
            </p>
